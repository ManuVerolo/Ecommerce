    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <x-jet-input class="w-full" type="text" placeholder="Ingrese el nombre del producto"
            ...
            <div class="mb-4">
                ...
                <x-jet-input class="w-full bg-gray-200" type="text" placeholder="Ingrese el slug del producto"
                ...
                @if (!$this->subcategory->color && !$this->subcategory->size)
                    <div>
                        ...
                        <x-jet-input wire:model="product.quantity" type="number"
                            placeholder="Ingrese la cantidad del producto" class="w-full" />
