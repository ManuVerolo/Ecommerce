        ...
        <aside>
            ...
            <ul class=" mb-4 divide-y divide-gray-200">
                @foreach ($category->subcategories as $subcategory)
                    <li class="py-2 ">
                        <a class="cursor-pointer hover:text-blue-600 capitalize {{ $subcategoria == $subcategory->slug ? 'text-blue-500 font-semibold' : '' }}"
            ...
            <x-jet-button class="mt-3" wire:click="limpiar">
                Eliminar filtros
            </x-jet-button>
        </aside>
